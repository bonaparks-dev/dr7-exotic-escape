...
const translations = {
  it: {
    ...
    'hero.subtitle': 'Scopri il mondo dei exotic cars, yacht di lusso, jet privati e ville esclusive',
    'hero.cta': 'Esplora i Nostri Servizi',
    'hero.scroll': 'Scorri per scoprire',
    
    'services.title': 'I Nostri Servizi',
    'services.supercars': 'Exotic Cars',
    'services.supercars.desc': 'Flotta esclusiva di exotic cars per esperienze indimenticabili',
    ...
    // Yacht Rental
    'yacht.title': 'DR7 Yacht di Lusso',
    'yacht.subtitle': 'Vivi l\'esperienza di lusso definitiva sulle acque cristalline della Sardegna',
  ...
  en: {
    ...
    'hero.subtitle': 'Discover the world of exotic cars, luxury yachts, private jets and exclusive villas',
    ...
    // Yacht Rental
    'yacht.title': 'DR7 Luxury Yacht',
    'yacht.subtitle': 'Experience the ultimate luxury on the crystal waters of Sardegna',

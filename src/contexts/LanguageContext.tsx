...
const translations = {
  it: {
    ...
    'lottery.heroText': 'Partecipa alla lotteria più esclusiva d\'Italia. Con soli 20€ puoi vincere una delle 19 supercar in palio per un valore totale di oltre 3 milioni di euro.',
    'lottery.ticketTitle': 'Il Tuo Biglietto',
    'lottery.prizePoolTitle': 'Supercar in Palio',
  ...
  en: {
    ...
    'lottery.back': 'Back',
    'lottery.heroText': 'Join Italy\'s most exclusive lottery. For just €20, you could win one of 19 supercars worth over 3 million euros in total.',
    'lottery.ticketTitle': 'Your Ticket',
    'lottery.prizePoolTitle': 'Supercars Prize Pool',
